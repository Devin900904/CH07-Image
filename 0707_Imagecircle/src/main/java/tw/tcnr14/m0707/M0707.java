    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.m0707_imgview:
                t001.setText(getString(R.string.m0707_t001)+getString(R.string.m0707_imageview));
                break;
            case R.id.m0707_imgbutton:
                t001.setText(getString(R.string.m0707_t001)+getString(R.string.m0707_ingbutton));
                break;
        }
    }
}